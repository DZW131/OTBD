...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--myo-radius", type=int, default=1)
    parser.add_argument("--vessel-radius", type=int, default=3)
    parser.add_argument("--min-volume-ratio", type=float, default=0.9)
    parser.add_argument("--max-volume-ratio", type=float, default=1.1)
    parser.add_argument("--min-iou-with-original", type=float, default=0.85)
